...
class ProductControllerTest {
	...
	ProductEntity mockProduct = new ProductEntity(5, "NOISE", 1699, 50, "Smart Fitness Band", "Men's Fashion",
	...
	void testGetProductById() throws Exception {
		Mockito.when(mockService.fetchProductById(Mockito.anyLong())).thenReturn(mockProduct);
		RequestBuilder req = MockMvcRequestBuilders.get("/product/5").accept(MediaType.APPLICATION_JSON);
		MvcResult res = mockMvc.perform(req).andReturn();
		String expected = "{productName:NOISE,unitPrice:1699.0}";
